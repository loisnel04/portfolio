        ...
        <header className={`${fade ? 'fade-out' : 'fade-in'}`}  >
            ...
            <div id="myself">
                ...
                <div id="text">
                    ...
                    <p>{language==='English' ? "I have a deep passion for computer science and science in general. I am highly motivated to apply my knowledge and skills in computer science for a company and keep learning during my career. I love helping people and aspire to contribute to their well-being by using technology." : "Je suis passioné par l'informatique, et les sciences en général. Je suis tres motivé à l'idée d'utiliser mes connaissances et mes compétences en informatique pour une entreprise avec qui je pourrais continuer à apprendre durant ma carrière. J'aime aider les gens et j’aspire à contribuer à leur bien-être grâce à l'informatique."}</p>
                </div>
            </div>
